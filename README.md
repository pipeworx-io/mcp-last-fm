...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/artist_info \
  -H 'Content-Type: application/json' \
  -d '{"artist":"The Beatles"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/artist_info`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
